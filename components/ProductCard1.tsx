...
export default function ProductCard({ product, onSelect }: ProductCardProps) {
  return (
    <div onClick={() => onSelect(product)} className="bg-white rounded-xl md:rounded-2xl shadow-md p-3 md:p-5 flex flex-col hover:shadow-xl transition-shadow duration-300 cursor-pointer">
