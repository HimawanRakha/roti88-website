    ...
    <section className="relative w-full h-[300px] md:h-[400px] flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <motion.a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex justify-center items-center gap-2 md:gap-5 w-full md:w-max px-4 py-3 md:px-6 md:py-4 bg-[#FF7A00] rounded-lg text-white text-[14px] md:text-xl font-semibold hover:bg-[#E06A00] transition-colors shadow-md mx-auto"
