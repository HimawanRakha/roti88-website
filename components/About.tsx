    ...
    <div className="w-full font-sans overflow-hidden">
      <section className="py-16 px-4 md:px-8  mx-auto text-center mb-20">
        <motion.h2
          ...
          className="text-2xl md:text-5xl font-bold mb-4 md:mb-6 text-black tracking-tight"
        >
          Tentang kami
        </motion.h2>
        <motion.p
          ...
          viewport={{ once: true, margin: "-50px" }}
          className="text-gray-700 mx-4 md:mx-32 mb-10 md:mb-12 leading-relaxed text-[13px] md:text-2xl mt-6 md:mt-12"
        >
        ...
        <motion.hr
          ...
          viewport={{ once: true }}
          className="border-t-2 border-gray-300 mb-12 mx-8 md:mx-52 origin-center"
        />
        ...
        >
          <div className="flex flex-col items-center py-4 md:py-0 px-1 sm:px-4 text-center">
            <span className="text-gray-500 mb-1 md:mb-2 md:text-lg font-medium text-[9px] sm:text-[13px] tracking-widest uppercase">Berdiri sejak</span>
            <span className="text-2xl sm:text-4xl lg:text-5xl font-semibold text-black font-sans drop-shadow-sm leading-none">
              <Counter end={2012} duration={2500} start={1950} />
            </span>
          </div>

          <div className="flex flex-col items-center py-4 md:py-0 px-1 sm:px-4 text-center">
            <span className="text-gray-500 mb-1 md:mb-2 md:text-lg font-medium text-[9px] sm:text-[13px] tracking-widest uppercase">Telah hadir</span>
            <span className="text-2xl sm:text-4xl lg:text-5xl font-semibold text-black font-serif tracking-tight drop-shadow-sm leading-none">
              <Counter end={8} duration={2000} />
            </span>
            <span className="text-gray-500 mt-1 md:text-lg font-medium text-[9px] sm:text-[13px] leading-tight">Cabang<br className="sm:hidden" /><span className="hidden sm:inline"> di Lumajang</span></span>
          </div>

          <div className="flex flex-col items-center py-4 md:py-0 px-1 sm:px-4 text-center">
            <span className="text-gray-500 mb-1 md:mb-2 md:text-lg font-medium text-[9px] sm:text-[13px] tracking-widest uppercase">Menjangkau</span>
            <span className="text-2xl sm:text-4xl lg:text-5xl font-semibold text-black font-serif tracking-tight drop-shadow-sm leading-none">
              <Counter end={3} suffix="Jt+" duration={2000} />
            </span>
            <span className="text-gray-500 mt-1 md:text-lg font-medium text-[9px] sm:text-[13px] leading-tight">Pelanggan</span>
          </div>
        </motion.div>
      </section>
      ...
      <section className="w-full">
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="bg-[#FF7A00] py-10 px-4 text-center"
        >
